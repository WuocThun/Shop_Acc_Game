...
{{--                                    <a data-toggle="collapse" data-parent="#accordion" href="">Thử vận may liên quân chỉ--}}
{{--                                        với--}}
...
{{--                                                href="https://nick.vn/mua-ban-nick-game-random" target="_blank">Shop--}}
{{--                                                chuyên--}}
{{--                                                bán acc liên quân random</a></strong> cho các bạn thử vận may với các--}}
{{--                                        gói ưu--}}
{{--                                        đãi khác nhau :</p>--}}
...
{{--                                            target="_blank"><strong>Random--}}
{{--                                                liên quân cao cấp 60k</strong></a></p>--}}
{{--                                    <p>.Các bạn sẽ có cơ hội nhận được những <a--}}
{{--                                            href="https://nick.vn/mua-ban-nick-game-random" target="_blank"><strong>acc--}}
{{--                                                liên--}}
{{--                                                quân ngẫu nhiên</strong> </a>có thể là acc víp,acc cùi, acc tầm--}}
{{--                                        trung..vv--}}
{{--                                    </p>--}}
...
{{--                            <div id="tab1" class="panel-collapse collapse in" aria-expanded="true" style="">--}}
{{--                                <div class="panel-body">--}}
{{--                                    <p>Ngoài&nbsp; <strong>shop bán acc liên quân</strong>&nbsp;Shop còn có các dịch vụ--}}
{{--                                        khác--}}
...
{{--                                                    style="color:#e74c3c">bán thẻ garena giá&nbsp; rẻ</span> </a>và hơn--}}
{{--                                            40--}}
{{--                                            dịch vụ game khác</strong> tại&nbsp;<strong><a--}}
{{--                                                href="https://nick.vn/dich-vu"--}}
...
{{--                                    </h3>--}}
{{--                                    <h3><span--}}
{{--                                            style="color:#ffffff"><strong>- Nick liên quân bản thử nghiệm</strong></span>--}}
{{--                                    </h3>--}}
{{--                                    <h3><span--}}
...
{{--                                    <h3><span style="color:#ffffff"><strong>- Nick liên quân full ngọc</strong></span>--}}
{{--                                    </h3>--}}
{{--                                    <h3><span style="color:#ffffff"><strong>- Nick liên quân giá rẻ 20k</strong></span>--}}
{{--                                    </h3>--}}
