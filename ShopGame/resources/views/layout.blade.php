...
<head>
    <meta charset="utf-8"/>
    <title>Web Bán Nick, Có Đủ Mọi Loại Game Hót Thịnh Hành Nick.vn</title>
    ...
    <meta name="author" content="nick.vn"/>
    ...
    <link href="{{asset('frontend/css/cubeportfolio.min.css')}}" rel="stylesheet"
          type="text/css"/>
    ...
    <!-- END: BASE PLUGINS -->
    <!-- BEGIN: PAGE STYLES -->
    <link href="{{asset('frontend/frontend/css/bootstrap-datepicker.min.css')}}"
          rel="stylesheet" type="text/css"/>
    ...
    <link href="{{asset('frontend/css/components.css')}}" id="style_components" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('frontend/css/default.css')}}" rel="stylesheet" id="style_theme"
          type="text/css"/>
...
<div class="h1tag"
     style="font-size:0px;text-indent:-1000px;height:0;width:0;position: absolute;z-index:-1000;padding:0;margin:0"></div>
<script>
    $(document).ready(function () {
        $('img').each(function () {
            if (!$(this).attr('alt')) // check if current image tag has alt attribute
            {
                $(this).attr('alt', 'png-image');
            } // if it doesn't add 'png-image' alt attribute
        });
    });
    setTimeout(function () {
        if ($('h1').length < 1) {
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NGBFK5Z"
        ...
        <div class="container">
            ...
            <nav class="c-top-menu c-pull-right m-t-10">
                <ul class="c-links c-theme-ul">
                    <li>
                        Hotline: <a
                            href="tel:08.6969.3000">08.6969.3000 </a>
                    </li>
        ...
        <div class="container">
            ...
            <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                ...
                <div class="owl-carousel owl-theme c-theme owl-bordered1 c-owl-nav-center" data-items="6"
                    ...
                    <div class="item">
                        <a href="https://nick.vn/user/profile"><img src="img/vHPm7XyQah_1623147701.jpg"
                                                                    alt="Trang cá nhân nickvn"/></a>
                    </div>
                    <div class="item">
                        <a href="https://nick.vn/dich-vu"><img src="img/vHPm7XyQah_1623147701.jpg"
                ...
                <div class="row row-flex-safari game-list">
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            ...
                            <div class="news_title">
                                <h2>
                                    <a href="/danh-muc/danh-muc-game-free-fire" title="Danh Mục Game Free Fire">Danh Mục
                                        Game Free Fire</a>
                                </h2>
                            </div>
                            <div class="news_description">
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            ...
                            <div class="news_title">
                                <h2>
                                    <a href="/danh-muc/danh-muc-game-ngoc-rong" title="Danh Mục Game Ngọc Rồng">Danh Mục
                                        Game Ngọc Rồng</a>
                                </h2>
                            </div>
                            <div class="news_description">
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            ...
                            <div class="news_title">
                                <h2>
                                    <a href="/danh-muc/danh-muc-game-pubg-mobile" title="Danh Mục Game Pubg Mobile">Danh
                                        Mục Game Pubg Mobile</a>
                                </h2>
                            </div>
                            <div class="news_description">
                                <p>
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            ...
                            <div class="news_title">
                                <h2>
                                    <a href="/danh-muc/danh-muc-game-roblox" title="Danh Mục Game Roblox">Danh Mục Game
                                        Roblox</a>
                                </h2>
                            </div>
                            <div class="news_description">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="c-container c-first">
                        ...
                        <p><span style="font-size:14px"><span style="color:#ffffff">Chuy&ecirc;n mua b&aacute;n nick&nbsp;all game, </span><a
                                    href="https://napgamegiare.net/"><span
                ...
                <div class="col-md-4">
                    <div class="c-container c-last">
                        ...
                        <h2><span style="color:#ffffff"><span style="font-size:22px"><strong>CH&Uacute;NG T&Ocirc;I Ở Đ&Acirc;Y</strong></span></span>
                        </h2>
                        <h3><span style="color:#ffffff"><span style="font-size:16px">Ch&uacute;ng t&ocirc;i l&agrave;m việc một c&aacute;ch chuy&ecirc;n nghiệp, uy t&iacute;n, nhanh ch&oacute;ng v&agrave; lu&ocirc;n đặt quyền lợi của bạn l&ecirc;n h&agrave;ng đầu.</span></span>
                        </h3>
                        <p>&nbsp;</p>
                        <p><span style="color:#ffffff">&nbsp;<strong>Hotline:</strong>&nbsp;<strong>0869693000</strong></span>
                        </p>
                        <p><span style="color:#ffffff">&nbsp;<strong>Thời gian l&agrave;m việc&nbsp;8h-11h30 &amp; 13h30-22h</strong></span>
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
...
<script async
        src="https://www.googletagmanager.com/gtag/js?id=G-MZBLL7R7EG"></script>
<script>
